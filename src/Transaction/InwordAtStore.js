...
import { TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Table, Alert, Grid, Autocomplete, useMediaQuery, Box, Button, IconButton, Typography, TextField, Drawer, Divider, FormControl, Select, MenuItem, Menu } from '@mui/material';
...
const InwordAtStore = () => {
    ...
    const columns = useMemo(() => {
        return [
            ...
            //             // onClick={(e) => {
            //             //     e.stopPropagation();
            //             //     handleDelete(row); // Pass the row data
            //             // }}
            //             color="error"
            //         >
            //             <DeleteIcon />
                                ...
                                <Box sx={{ display: "flex", gap: 2 }}>
                                    ...
                                    <Box  >
                                        ...
                                        <TextField
                                            ...
                                            size="small" fullWidth placeholder='Batch No' />
                                    </Box>
                                ...
                                <Box sx={{ display: "flex", gap: 2 }}>
                                    <Box >
                                        ...
                                        <TextField
                                            ...
                                            size="small" fullWidth placeholder='Quantity' />
                                    </Box>
                                    ...
                                    <Box >
                                        ...
                                        <TextField
                                            ...
                                            size="small" fullWidth placeholder='Rate' />
                                    </Box>
                                    <Box >
                                        ...
                                        <TextField
                                            ...
                                            size="small" fullWidth placeholder='Amount' />
                                    </Box>
                                </Box>
                            </Box> */}
