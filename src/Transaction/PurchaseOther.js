...
//     setIgstTotal(rowData.IGSTAmount);
//     setCgstTotal(rowData.CGSTAmount)
//     setSubTotalCal(rowData.SubTotal)
//     //CGST Amount
//     // setCGSTAmount(rowData.CGSTAmount)
//     //SGST Amount
//     // setSGSTAmount(rowData.SGSTAmount)
...
// {/* 
//                 <Box display={'flex'} alignItems={'center'} gap={15} p={2} mt={1} justifyContent={'space-between'}>
//                   <Box>
//                     <Typography>CGST Amount:</Typography>
//                     <b>{cgstTotal} Rs</b>
//                   </Box>
