          ...
          <Box>
            <Box display="flex" alignItems="center" gap={2}>
              <Box flex={1} >
                <Box m={1.5}>
                  <Typography>Account Code</Typography>
                  <TextField size="small" margin="normal" placeholder="Enter Account Code" fullWidth />
                ...
                <Box m={1.5}>
                  <Typography>Address 1</Typography>
                  <TextField size="small" margin="normal" placeholder="Enter Address 1" fullWidth />
                ...
                <Box m={1.5}>
                  <Typography>Pincode</Typography>
                  <TextField size="small" margin="normal" placeholder="Enter pincode" fullWidth />
              ...
              <Box flex={1} >
                ...
                <Box m={1.5}>
                  <Typography>Email</Typography>
                  <TextField size="small" margin="normal" placeholder="Enter Email" fullWidth />
